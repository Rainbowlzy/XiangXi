...
require.config({
    paths: {
        ...
        "cmodules": ["../assets/js/0-common/cmodules-compiled"],
        ...
        "echarts": ['https://cdn.bootcss.com/echarts/4.1.0.rc2/echarts.min'
        //assets/js/0-common/echarts-all.js
        //'../assets/js/0-common/echarts-all'
        ],
...
//# sourceMappingURL=app-local-compiled.js.map