...
define(['vue', 'jquery', 'jquery.cookie', 'echarts'
//, 'bootstrap'
//, "bootstrap-table"
//, 'bootstrap-typeahead'
...
//, "ueditor"
    ...
    window.Call = function Call(method, data, callback) {
        ...
        //$.post(svcHeader + "/XiangXi/DefaultHandler.ashx?method=" + method + '&auth_user=' + cookie, {data: JSON.stringify(data)}, function (resp) {
        var params = $.extend({ data: JSON.stringify(data) }, data instanceof Array ? {} : data);
        $.post(SVC_NEW + "?method=" + method + '&auth_user=' + cookie, params, function (resp) {
            if (!callback) {
        ...
        login: function login(user, pwd) {
            $.call('login', {
                ...
                if (!(data && data.success)) {
                    ...
                    if (location.href.indexOf('login.html') !== -1) location.href = '../1_index/business.html';
                }
            });
        },
...
//# sourceMappingURL=cmodules-compiled.js.map