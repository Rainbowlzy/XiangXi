    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SavePersonnel", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"PersonnelList.html?table=Personnel"
                });
            },

			back(){
				window.location.href = site_gen+"Personnel.html?table=Personnel"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetPersonnelEmpty", {}, function(data) {
					data = data||{};
