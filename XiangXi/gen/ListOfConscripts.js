    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveListOfConscripts", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"ListOfConscriptsList.html?table=ListOfConscripts"
                });
            },

			back(){
				window.location.href = site_gen+"ListOfConscripts.html?table=ListOfConscripts"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetListOfConscriptsEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ListOfConscripts'
					vm = new Vue({
						el: "#ListOfConscripts",
						data: data||{},
						computed:{
				...
				request.table = 'ListOfConscripts'
				vm = new Vue({
					el: "#ListOfConscripts",
					data: request||{},
					computed:{
