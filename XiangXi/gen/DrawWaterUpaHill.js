    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveDrawWaterUpaHill", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"DrawWaterUpaHillList.html?table=DrawWaterUpaHill"
                });
            },

			back(){
				window.location.href = site_gen+"DrawWaterUpaHill.html?table=DrawWaterUpaHill"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetDrawWaterUpaHillEmpty", {}, function(data) {
					data = data||{};
					data.table = 'DrawWaterUpaHill'
					vm = new Vue({
						el: "#DrawWaterUpaHill",
						data: data||{},
						computed:{
				...
				request.table = 'DrawWaterUpaHill'
				vm = new Vue({
					el: "#DrawWaterUpaHill",
					data: request||{},
					computed:{
