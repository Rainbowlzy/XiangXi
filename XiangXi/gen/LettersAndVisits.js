    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveLettersAndVisits", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"LettersAndVisitsList.html?table=LettersAndVisits"
                });
            },

			back(){
				window.location.href = site_gen+"LettersAndVisits.html?table=LettersAndVisits"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetLettersAndVisitsEmpty", {}, function(data) {
					data = data||{};
					data.table = 'LettersAndVisits'
					vm = new Vue({
						el: "#LettersAndVisits",
						data: data||{},
						computed:{
				...
				request.table = 'LettersAndVisits'
				vm = new Vue({
					el: "#LettersAndVisits",
					data: request||{},
					computed:{
