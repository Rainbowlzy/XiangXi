    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SavePopulation", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"PopulationList.html?table=Population"
                });
            },

			back(){
				window.location.href = site_gen+"Population.html?table=Population"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetPopulationEmpty", {}, function(data) {
					data = data||{};
