    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveExpertManagement", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"ExpertManagementList.html?table=ExpertManagement"
                });
            },

			back(){
				window.location.href = site_gen+"ExpertManagement.html?table=ExpertManagement"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetExpertManagementEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ExpertManagement'
					vm = new Vue({
						el: "#ExpertManagement",
						data: data||{},
						computed:{
				...
				request.table = 'ExpertManagement'
				vm = new Vue({
					el: "#ExpertManagement",
					data: request||{},
					computed:{
