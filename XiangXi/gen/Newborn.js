    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveNewborn", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"NewbornList.html?table=Newborn"
                });
            },

			back(){
				window.location.href = site_gen+"Newborn.html?table=Newborn"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetNewbornEmpty", {}, function(data) {
					data = data||{};
					data.table = 'Newborn'
					vm = new Vue({
						el: "#Newborn",
