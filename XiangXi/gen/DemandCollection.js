    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveDemandCollection", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"DemandCollectionList.html?table=DemandCollection"
                });
            },

			back(){
				window.location.href = site_gen+"DemandCollection.html?table=DemandCollection"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetDemandCollectionEmpty", {}, function(data) {
					data = data||{};
					data.table = 'DemandCollection'
					vm = new Vue({
						el: "#DemandCollection",
						data: data||{},
						computed:{
				...
				request.table = 'DemandCollection'
				vm = new Vue({
					el: "#DemandCollection",
					data: request||{},
					computed:{
