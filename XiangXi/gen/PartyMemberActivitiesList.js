...
$(document).ready(function(){
		...
		var vm = new Vue({
			...
			mounted:function(){
				...
				var $table = $("#tablePartyMemberActivities")
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/XiangXi/DefaultHandler.ashx?method=getPartyMemberActivitiesList&data=" + JSON.stringify(GetRequest()) + "&");
				...
				var operateEvents = {
					...
					'click .edit': function(e, value, row, index) {
						...
						window.location.href = "/XiangXi/gen/PartyMemberActivities.html?table=PartyMemberActivities&data=" + encodeURIComponent(JSON.stringify(row));
					},
					//删除
					'click .remove': function(e, value, row, index) {
						...
						//后台删除
						$.call('DeletePartyMemberActivities',row,function(data){
				...
				$table.bootstrapTable({
					...
					columns: [[
							...
							}, 
						{
							...
							{	
								formatter: imgFormatter('PMAActivePhotos'),
								field: "PMAActivePhotos",
								title: "活动照片",
