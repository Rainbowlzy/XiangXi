...
$(document).ready(function(){
		...
		var vm = new Vue({
			...
			mounted:function(){
				...
				$('.excel-import-button-UserMenu').click(function () {
						...
						$('.table_excel_modal-UserMenu').on('shown.bs.modal',function(){
							...
							$(".excel_file").fileinput({
								language: 'zh', //设置语言
								uploadUrl: "/XiangXi/ExcelImport.ashx?fileType=UserMenu", //上传的地址
				...
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/XiangXi/DefaultHandler.ashx?method=getUserMenuList&data=" + JSON.stringify(GetRequest()) + "&");
				...
				var operateEvents = {
					...
					'click .edit': function(e, value, row, index) {
						...
						window.location.href = "/XiangXi/gen/UserMenu.html?table=UserMenu&data=" + encodeURIComponent(JSON.stringify(row));
					},
					//删除
					'click .remove': function(e, value, row, index) {
						...
						//后台删除
						$.call('DeleteUserMenu',row,function(data){
				...
				$table.bootstrapTable({
					...
					columns: [[
							...
							}, 
						{
							...
							{	
								formatter: limitFormatter('UMTitle'),
								field: "UMTitle",
								title: "标题",
