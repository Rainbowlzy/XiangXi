...
$(document).ready(function(){
		...
		var vm = new Vue({
			...
			mounted:function(){
				...
				var $table = $("#tableVillageHistory")
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/XiangXi/DefaultHandler.ashx?method=getVillageHistoryList&data=" + JSON.stringify(GetRequest()) + "&");
				...
				var operateEvents = {
					...
					'click .edit': function(e, value, row, index) {
						...
						window.location.href = "/XiangXi/gen/VillageHistory.html?table=VillageHistory&data=" + encodeURIComponent(JSON.stringify(row));
					},
					//删除
					'click .remove': function(e, value, row, index) {
						...
						//后台删除
						$.call('DeleteVillageHistory',row,function(data){
				...
				$table.bootstrapTable({
					...
					columns: [[
							...
							}, 
						{
							...
							{	
								formatter: limitFormatter('VHMainTitle'),
								field: "VHMainTitle",
								title: "主标题",
							...
							{	
								formatter: imgFormatter('VHPicture'),
								field: "VHPicture",
								title: "图片",
