...
$(document).ready(function(){
		...
		var vm = new Vue({
			...
			mounted:function(){
				...
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/XiangXi/DefaultHandler.ashx?method=getRoleConfigurationList&data=" + JSON.stringify(GetRequest()) + "&");
				...
				var operateEvents = {
					...
					'click .edit': function(e, value, row, index) {
						...
						window.location.href = "/XiangXi/gen/RoleConfiguration.html?table=RoleConfiguration&data=" + encodeURIComponent(JSON.stringify(row));
					},
					//删除
					'click .remove': function(e, value, row, index) {
						...
						//后台删除
						$.call('DeleteRoleConfiguration',row,function(data){
				...
				$table.bootstrapTable({
					...
					columns: [[
							...
							}, 
						{
							...
							{
								field: "RCAffiliatedOrganization",
								title: "所属组织",
