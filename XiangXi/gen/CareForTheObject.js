    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveCareForTheObject", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"CareForTheObjectList.html?table=CareForTheObject"
                });
            },

			back(){
				window.location.href = site_gen+"CareForTheObject.html?table=CareForTheObject"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetCareForTheObjectEmpty", {}, function(data) {
					data = data||{};
					data.table = 'CareForTheObject'
					vm = new Vue({
						el: "#CareForTheObject",
						data: data||{},
						computed:{
				...
				request.table = 'CareForTheObject'
				vm = new Vue({
					el: "#CareForTheObject",
					data: request||{},
					computed:{
