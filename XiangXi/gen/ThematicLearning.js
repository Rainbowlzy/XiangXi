    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveThematicLearning", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"ThematicLearningList.html?table=ThematicLearning"
                });
            },

			back(){
				window.location.href = site_gen+"ThematicLearning.html?table=ThematicLearning"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetThematicLearningEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ThematicLearning'
					vm = new Vue({
						el: "#ThematicLearning",
						data: data||{},
						computed:{
				...
				request.table = 'ThematicLearning'
				vm = new Vue({
					el: "#ThematicLearning",
					data: request||{},
					computed:{
