...
$(document).ready(function(){
		...
		var vm = new Vue({
			...
			mounted:function(){
				...
				//表格传区域ID参数
				var url = "";
				$table.attr("data-url", "/XiangXi/DefaultHandler.ashx?method=getMenuConfigurationList&data=" + JSON.stringify(GetRequest()) + "&");
				...
				var operateEvents = {
					...
					'click .edit': function(e, value, row, index) {
						...
						window.location.href = "/XiangXi/gen/MenuConfiguration.html?table=MenuConfiguration&data=" + encodeURIComponent(JSON.stringify(row));
					},
					//删除
				...
				$table.bootstrapTable({
					...
					columns: [[
						...
						{	
								formatter: limitFormatter('MCTitle'),
								field: "MCTitle",
								title: "标题",
