    ...
    $(document).ready(function() {
        ...
        var method = {
            ...
            save() {
                ...
                $.call("SaveConvenienceGuide", datum, function(data) {
					if(!data) return bootstrap_alert('返回数据为空')
					if(!data.success) return bootstrap_alert(data.message)
					window.location.href = site_gen+"ConvenienceGuideList.html?table=ConvenienceGuide"
                });
            },

			back(){
				window.location.href = site_gen+"ConvenienceGuide.html?table=ConvenienceGuide"
			},
			...
			if (!request || request.id === undefined) {
				$.call("GetConvenienceGuideEmpty", {}, function(data) {
					data = data||{};
					data.table = 'ConvenienceGuide'
					vm = new Vue({
						el: "#ConvenienceGuide",
						data: data||{},
						computed:{
				...
				request.table = 'ConvenienceGuide'
				vm = new Vue({
					el: "#ConvenienceGuide",
					data: request||{},
					computed:{
