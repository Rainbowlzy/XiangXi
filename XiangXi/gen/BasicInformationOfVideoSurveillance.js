	...
	$(document).ready(function () {
		...
		var created = function created() {
			...
			$('.excel-import-button-BasicInformationOfVideoSurveillance').click(function () {
				...
				$('.table_excel_modal-BasicInformationOfVideoSurveillance').on('shown.bs.modal', function () {
					$('.table_excel_modal-BasicInformationOfVideoSurveillance .modal-body').html('<input class="excel_file input-file form-control" type="file">');
					...
					$(".excel_file").on("fileuploaded", function () {
						window.location.href = site_gen + "BasicInformationOfVideoSurveillanceList.html";
					});
				});
		...
		var method = {
			...
			save: function save() {
				...
				$.call("SaveBasicInformationOfVideoSurveillance", datum, function (data) {
			...
			back: function back() {
				window.location.href = site_gen + "BasicInformationOfVideoSurveillance.html?table=BasicInformationOfVideoSurveillance";
			},
		...
		if (!request || request.id === undefined) {
			$.call("GetBasicInformationOfVideoSurveillanceEmpty", {}, function (data) {
				data = data || {};
				data.table = 'BasicInformationOfVideoSurveillance';
				vm = new Vue({
					el: "#BasicInformationOfVideoSurveillance",
					data: data || {},
					methods: method,
					mounted: created
				});
			...
			request.table = 'BasicInformationOfVideoSurveillance';
			vm = new Vue({
				el: "#BasicInformationOfVideoSurveillance",
				data: request || {},
				methods: method,
...
//# sourceMappingURL=BasicInformationOfVideoSurveillance-compiled.js.map